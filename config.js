...
module.exports = {
    ...
    ownernumber: process.env.Owner_Number || "16582148118",
    ...
    cooldown: Number(process.env.Cooldown_Timer_Seconds) || 2, // default cooldown time per command in seconds
    mongoUrl: process.env.MongoDB || "mongodb+srv://dontayem:dontayem@cluster0.wtijtjj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0",
    sessionId: process.env.SESSION_ID || "VjK73XE_A_N_Y_A_V_2_X1A30vKBMbsBx",
